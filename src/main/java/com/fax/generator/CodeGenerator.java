...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/generator?serverTimezone=UTC&useSSL=false&characterEncoding=utf-8");//驱动连接的URL
        ...
        pc.setParent("com.fax.generator"); // 生成的代码的父路径
        ...
        strategy.setInclude("USER"); // 要生成的表在数据库中的名称, 每张表名以英文逗号隔开
